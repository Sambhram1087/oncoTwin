    ...
    <div className="min-h-screen flex flex-col md:flex-row bg-background">
      ...
      >
        ...
        <button 
          ...
          className="absolute right-4 top-[22px] translate-x-1/2 h-6 w-6 rounded-full bg-border border border-background flex items-center justify-center z-50 hover:bg-primary hover:text-primary-foreground hover:scale-110 transition-all"
        >
